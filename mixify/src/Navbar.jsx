...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (window.innerWidth >= 760) {
      ...
      const bgColor = rootStyles
        .getPropertyValue("--tertiary-background")
        .trim();
  ...
  const handleNavScroll = () => {
    if (!mobileDrawerOpenRef.current || mobileDrawerOpen) {
      ...
      const rootStyles = getComputedStyle(document.body);
      const bgColorRgb = rootStyles
        .getPropertyValue("--tertiary-background-rgb")
        .trim();
    ...
    <nav className="nav">
        ...
        <div className="mobile-navbar">
          <button onClick={toggleNavbar} className="menu-button">
            {mobileDrawerOpen ? (
              ...
              >
                <path
                  d="M40 40L30 30M30 30L20 20M30 30L40 20M30 30L20 40"
                  stroke="white"
                  strokeWidth="5"
                  strokeLinecap="round"
      ...
      <div className={`menu ${mobileDrawerOpen ? "open" : ""}`}>
        ...
        <ul>
          ...
          <Link to="/features" className="menu-features" onClick={toggleNavbar}>
            <li> Features</li>
          </Link>
